...
component variable belongs to one component, and 858 of the 968 entries merely _alias_ a
...
- `$extensions.com.4sh.ui-kit.skipped` lists 37 entries with nothing to create: `calc()`
