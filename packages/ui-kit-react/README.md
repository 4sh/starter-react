...
| `navigation`  | `ui-bottom-tab-bar`, `ui-breadcrumb`, `ui-context-menu`, `ui-menu`, `ui-stepper`, `ui-tabs`                                                                                                                                                                                                                                                                                           |
| `table`       | `ui-paginator`, `ui-table`                                                                                                                                                                                                                                                                                                                                                            |

**58 components** out of the Design System's 62. Roadmap: `docs/components-index.md`.
